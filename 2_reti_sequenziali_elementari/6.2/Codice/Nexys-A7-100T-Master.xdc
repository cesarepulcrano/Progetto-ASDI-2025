...
create_clock -add -name sys_clk_pin -period 10000000.00 -waveform {0 5} [get_ports {CLK100MHZ}];
...
set_property -dict { PACKAGE_PIN R18   IOSTANDARD LVCMOS33 } [get_ports { L }]; #IO_L7P_T1_D09_14 Sch=led[4]
