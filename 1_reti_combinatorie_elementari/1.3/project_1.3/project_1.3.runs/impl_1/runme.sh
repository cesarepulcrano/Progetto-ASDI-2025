...
HD_PWD='/home/cesare/ASDI/1/1.3/project_1.3/project_1.3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log net_16_4_fpga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source net_16_4_fpga.tcl -notrace
