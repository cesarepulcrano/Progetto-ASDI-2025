...
HD_PWD='/home/cesare/ASDI/1/1.3/project_1.3/project_1.3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log net_16_4_fpga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source net_16_4_fpga.tcl
