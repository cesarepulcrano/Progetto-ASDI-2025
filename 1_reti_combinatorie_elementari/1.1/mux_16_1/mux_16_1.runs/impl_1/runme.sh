...
HD_PWD='/home/cesare/ASDI/1/1.1/mux_16_1/mux_16_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_16_1_tb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux_16_1_tb.tcl -notrace
