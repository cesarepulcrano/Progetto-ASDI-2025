...
HD_PWD='/home/cesare/ASDI/1/1.2/project_1.2/project_1.2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log net_16_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source net_16_4.tcl
