...
HD_PWD='/home/cesare/ASDI/1/1.2/project_1.2/project_1.2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log net_16_4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source net_16_4.tcl -notrace
