...
HD_PWD='/home/cesare/Uni/Progetto-ASDI-2025/test+/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log button_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source button_test.tcl
