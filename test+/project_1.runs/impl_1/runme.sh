...
HD_PWD='/home/cesare/Uni/Progetto-ASDI-2025/test+/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log button_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source button_test.tcl -notrace
